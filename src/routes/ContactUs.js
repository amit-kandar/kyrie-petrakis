...
function ContactUs() {
    ...
    return (
        <section className="w-full py-10 px-5 lg:px-20 bg-gray-700">
            <div className='flex flex-col justify-around gap-5 md:gap-x-16 md:flex-row'>
                <div className="w-full max-w-[600px] flex-1 mx-auto mt-8 p-6 bg-gray-800 rounded-md shadow-lg">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="max-w-3xl mx-auto flex flex-wrap items-start gap-4 my-8">
                            <div className="grid gap-1.5 w-full">
                                <label className="block text-sm font-medium text-gray-100" htmlFor="first-name">
                                    First name
                                </label>
                                <input id="first-name" placeholder="Enter your first name" className="bg-transparent border-2 border-zinc-500 rounded-md py-3 pl-5 outline-none text-gray-100 focus:border-zinc-200 duration-200" onCanPlay={handleChange} />
                            </div>
                            <div className="grid gap-1.5 w-full">
                                <label className="block text-sm font-medium text-gray-100" htmlFor="last-name">
                                    Last name
                                </label>
                                <input id="last-name" placeholder="Enter your last name" className="bg-transparent border-2 border-zinc-500 rounded-md py-3 pl-5 outline-none text-gray-100 focus:border-zinc-200 duration-200" onCanPlay={handleChange} />
                            </div>
                            <div className="grid gap-1.5 w-full">
                            ...
                            <div className="grid gap-1.5 w-full">
                                ...
                                <input id="service" placeholder="Enter service name" type="text" className="bg-transparent border-2 border-zinc-500 rounded-md py-3 pl-5 outline-none text-gray-100 focus:border-zinc-200 duration-200" onCanPlay={handleChange} />
                            </div>
                            <div className="grid gap-1.5 w-full">
                ...
                <div className='flex flex-col flex-1 gap-6'>
                    <div className='w-full mt-10'>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5209.974580116529!2d88.40267528884736!3d22.578790820802357!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a027677c1c8a03b%3A0xe1bc02832a8f64a4!2sMani%20Square!5e0!3m2!1sen!2sin!4v1708165745892!5m2!1sen!2sin" className='w-full h-[200px] sm:h-80 md:h-96 rounded-md' allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title='map' color='dark' ></iframe>
                    </div>
                    <div className='w-full flex flex-col justify-between gap-2 sm:flex-row'>
                        <div className='p-3'>
                            <p className='text-sm font-medium text-white opacity-70'>Main Office<br />123 Anywhere St.<br />Any City ST 12345</p>
                        </div>
                        <div className='p-3'>
